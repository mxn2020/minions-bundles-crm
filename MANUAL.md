# Manual Setup Steps for Minions Bundle: Crm
...
Go to **GitHub → mxn2020/minions-bundles-crm → Settings → Secrets and variables → Actions** and add:
...
### Web App (Playground)
- **Netlify site name**: `minions-bundles-crm-web`
- **GitHub repo**: `mxn2020/minions-bundles-crm`
...
### Documentation
- **Netlify site name**: `minions-bundles-crm-docs`
- **GitHub repo**: `mxn2020/minions-bundles-crm`
...
### Blog
- **Netlify site name**: `minions-bundles-crm-blog`
- **GitHub repo**: `mxn2020/minions-bundles-crm`
...
|--------|------|------|-------|
| Docs | CNAME | `crm.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `crm.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `crm.minions.wtf` | _(Netlify subdomain)_ |
...
| Item | Value |
|------|-------|
| Project | `minions-bundles-crm` |
| SDK (npm) | `undefined` |
| CLI (npm) | `undefined` |
| Python (PyPI) | `undefined` |
| GitHub | `github.com/mxn2020/minions-bundles-crm` |

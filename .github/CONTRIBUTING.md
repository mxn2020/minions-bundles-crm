# Contributing to Minions Bundle: Crm

Thank you for your interest in contributing to Minions Bundle: Crm!

## Getting Started

1. Fork the repository
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/minions-bundles-crm.git`
